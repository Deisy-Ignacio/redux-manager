        ...
        <div ref={gridJugadores} onClick={() => setScrollContainer.bind(this)}>
          {jugadores.map((jugador) => (
            <article className="jugador" key={jugador.id}>
              <img src={jugador.foto} alt={jugador.nombre}></img>
...
const mapDispatchToProps = (dispatch) => ({
  //funciones que van a ser leidas por el reducer
...
}); //funcion que se convierten en propiedades

export default connect(mapStateToProps, mapDispatchToProps)(Jugadores);
//a fuuncion connect recibe 2 funciones la primera es una función que mapea lo que está en el state, la segunda fución será el componente
